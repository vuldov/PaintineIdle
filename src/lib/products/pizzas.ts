...
const suppliers: Record<string, SupplierData> = {
  [MARAICHER_ITALIEN as string]: {
    ...
    baseMaxRate: new Decimal(2), baseCostPerSecond: new Decimal(100),
  ...
  [FROMAGERIE_NAPOLITAINE as string]: {
    ...
    baseMaxRate: new Decimal(2.5), baseCostPerSecond: new Decimal(150),
  ...
  [MOULIN_SICILIEN as string]: {
    ...
    baseMaxRate: new Decimal(3), baseCostPerSecond: new Decimal(120),
  ...
  [HERBORISTE as string]: {
    ...
    baseMaxRate: new Decimal(1.5), baseCostPerSecond: new Decimal(80),
  ...
  [LEVURERIE as string]: {
    ...
    baseMaxRate: new Decimal(2), baseCostPerSecond: new Decimal(80),
    contractCost: new Decimal(40_000), scope: 'pizzas',
  },
}
