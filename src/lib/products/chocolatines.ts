...
const supplierUpgrades: Record<string, SupplierUpgradeData> = {
  ...
  // ── Ferme laitiere (baseCost=15, costGrowth=2.0, costResource=PATE_BRIOCHEE) ──
  [supplierUpgradeId('ferme_laitiere_rate_1') as string]: {
    ...
    cost: new Decimal(15), costResource: PATE_BRIOCHEE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('ferme_laitiere_cost_1') as string]: {
    ...
    targetSupplier: FERME_LAITIERE,
    cost: new Decimal(30), costResource: PATE_BRIOCHEE,
    effectType: 'cost_reduction', effectValue: new Decimal(0.8),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('ferme_laitiere_rate_2') as string]: {
    ...
    description: 'x3 debit max - Ferme laitiere',
    targetSupplier: FERME_LAITIERE,
    cost: new Decimal(60), costResource: PATE_BRIOCHEE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('ferme_laitiere_cost_2') as string]: {
    ...
    description: 'x0,8 cout - Ferme laitiere',
    targetSupplier: FERME_LAITIERE,
    cost: new Decimal(120), costResource: PATE_BRIOCHEE,
    effectType: 'cost_reduction', effectValue: new Decimal(0.8),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('ferme_laitiere_rate_3') as string]: {
    ...
    description: 'x3 debit max - Ferme laitiere',
    targetSupplier: FERME_LAITIERE,
    cost: new Decimal(240), costResource: PATE_BRIOCHEE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('ferme_laitiere_cost_3') as string]: {
    ...
    description: 'x0,8 cout - Ferme laitiere',
    targetSupplier: FERME_LAITIERE,
    cost: new Decimal(480), costResource: PATE_BRIOCHEE,
    effectType: 'cost_reduction', effectValue: new Decimal(0.8),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('ferme_laitiere_rate_4') as string]: {
    ...
    description: 'x3 debit max - Ferme laitiere',
    targetSupplier: FERME_LAITIERE,
    cost: new Decimal(960), costResource: PATE_BRIOCHEE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('ferme_laitiere_cost_4') as string]: {
    ...
    description: 'x0,8 cout - Ferme laitiere',
    targetSupplier: FERME_LAITIERE,
    cost: new Decimal(1920), costResource: PATE_BRIOCHEE,
    effectType: 'cost_reduction', effectValue: new Decimal(0.8),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('ferme_laitiere_rate_5') as string]: {
    ...
    description: 'x3 debit max - Ferme laitiere',
    targetSupplier: FERME_LAITIERE,
    cost: new Decimal(3840), costResource: PATE_BRIOCHEE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('ferme_laitiere_cost_5') as string]: {
    ...
    description: 'x0,8 cout - Ferme laitiere',
    targetSupplier: FERME_LAITIERE,
    cost: new Decimal(7680), costResource: PATE_BRIOCHEE,
    effectType: 'cost_reduction', effectValue: new Decimal(0.8),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('ferme_laitiere_rate_6') as string]: {
    ...
    description: 'x3 debit max - Ferme laitiere',
    targetSupplier: FERME_LAITIERE,
    cost: new Decimal(15360), costResource: PATE_BRIOCHEE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },

  // ── Plantation vanille (baseCost=18, costGrowth=1.6, costResource=PATE_BRIOCHEE) ──
  [supplierUpgradeId('plantation_vanille_rate_1') as string]: {
    ...
    cost: new Decimal(18), costResource: PATE_BRIOCHEE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('plantation_vanille_cost_1') as string]: {
    ...
    targetSupplier: PLANTATION_VANILLE,
    cost: new Decimal(29), costResource: PATE_BRIOCHEE,
    effectType: 'cost_reduction', effectValue: new Decimal(0.8),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('plantation_vanille_rate_2') as string]: {
    ...
    description: 'x3 debit max - Plantation vanille',
    targetSupplier: PLANTATION_VANILLE,
    cost: new Decimal(46), costResource: PATE_BRIOCHEE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('plantation_vanille_cost_2') as string]: {
    ...
    description: 'x0,8 cout - Plantation vanille',
    targetSupplier: PLANTATION_VANILLE,
    cost: new Decimal(74), costResource: PATE_BRIOCHEE,
    effectType: 'cost_reduction', effectValue: new Decimal(0.8),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('plantation_vanille_rate_3') as string]: {
    ...
    description: 'x3 debit max - Plantation vanille',
    targetSupplier: PLANTATION_VANILLE,
    cost: new Decimal(118), costResource: PATE_BRIOCHEE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('plantation_vanille_cost_3') as string]: {
    ...
    description: 'x0,8 cout - Plantation vanille',
    targetSupplier: PLANTATION_VANILLE,
    cost: new Decimal(189), costResource: PATE_BRIOCHEE,
    effectType: 'cost_reduction', effectValue: new Decimal(0.8),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('plantation_vanille_rate_4') as string]: {
    ...
    description: 'x3 debit max - Plantation vanille',
    targetSupplier: PLANTATION_VANILLE,
    cost: new Decimal(302), costResource: PATE_BRIOCHEE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('plantation_vanille_cost_4') as string]: {
    ...
    description: 'x0,8 cout - Plantation vanille',
    targetSupplier: PLANTATION_VANILLE,
    cost: new Decimal(483), costResource: PATE_BRIOCHEE,
    effectType: 'cost_reduction', effectValue: new Decimal(0.8),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('plantation_vanille_rate_5') as string]: {
    ...
    description: 'x3 debit max - Plantation vanille',
    targetSupplier: PLANTATION_VANILLE,
    cost: new Decimal(773), costResource: PATE_BRIOCHEE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('plantation_vanille_cost_5') as string]: {
    ...
    description: 'x0,8 cout - Plantation vanille',
    targetSupplier: PLANTATION_VANILLE,
    cost: new Decimal(1237), costResource: PATE_BRIOCHEE,
    effectType: 'cost_reduction', effectValue: new Decimal(0.8),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('plantation_vanille_rate_6') as string]: {
    ...
    description: 'x3 debit max - Plantation vanille',
    targetSupplier: PLANTATION_VANILLE,
    cost: new Decimal(1979), costResource: PATE_BRIOCHEE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },

  // ── Elevage de poules (baseCost=6, costGrowth=2.2, costResource=CHOCOLATINE_DOREE) ──
  [supplierUpgradeId('elevage_poules_rate_1') as string]: {
    ...
    cost: new Decimal(6), costResource: CHOCOLATINE_DOREE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('elevage_poules_cost_1') as string]: {
    ...
    targetSupplier: ELEVAGE_POULES,
    cost: new Decimal(13), costResource: CHOCOLATINE_DOREE,
    effectType: 'cost_reduction', effectValue: new Decimal(0.8),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('elevage_poules_rate_2') as string]: {
    ...
    description: 'x3 debit max - Elevage de poules',
    targetSupplier: ELEVAGE_POULES,
    cost: new Decimal(29), costResource: CHOCOLATINE_DOREE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('elevage_poules_cost_2') as string]: {
    ...
    description: 'x0,8 cout - Elevage de poules',
    targetSupplier: ELEVAGE_POULES,
    cost: new Decimal(64), costResource: CHOCOLATINE_DOREE,
    effectType: 'cost_reduction', effectValue: new Decimal(0.8),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('elevage_poules_rate_3') as string]: {
    ...
    description: 'x3 debit max - Elevage de poules',
    targetSupplier: ELEVAGE_POULES,
    cost: new Decimal(140), costResource: CHOCOLATINE_DOREE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('elevage_poules_cost_3') as string]: {
    ...
    description: 'x0,8 cout - Elevage de poules',
    targetSupplier: ELEVAGE_POULES,
    cost: new Decimal(308), costResource: CHOCOLATINE_DOREE,
    effectType: 'cost_reduction', effectValue: new Decimal(0.8),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('elevage_poules_rate_4') as string]: {
    ...
    description: 'x3 debit max - Elevage de poules',
    targetSupplier: ELEVAGE_POULES,
    cost: new Decimal(678), costResource: CHOCOLATINE_DOREE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('elevage_poules_cost_4') as string]: {
    ...
    description: 'x0,8 cout - Elevage de poules',
    targetSupplier: ELEVAGE_POULES,
    cost: new Decimal(1491), costResource: CHOCOLATINE_DOREE,
    effectType: 'cost_reduction', effectValue: new Decimal(0.8),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('elevage_poules_rate_5') as string]: {
    ...
    description: 'x3 debit max - Elevage de poules',
    targetSupplier: ELEVAGE_POULES,
    cost: new Decimal(3281), costResource: CHOCOLATINE_DOREE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('elevage_poules_cost_5') as string]: {
    ...
    description: 'x0,8 cout - Elevage de poules',
    targetSupplier: ELEVAGE_POULES,
    cost: new Decimal(7218), costResource: CHOCOLATINE_DOREE,
    effectType: 'cost_reduction', effectValue: new Decimal(0.8),
    scope: 'chocolatines',
  },
  [supplierUpgradeId('elevage_poules_rate_6') as string]: {
    ...
    description: 'x3 debit max - Elevage de poules',
    targetSupplier: ELEVAGE_POULES,
    cost: new Decimal(15879), costResource: CHOCOLATINE_DOREE,
    effectType: 'max_rate_bonus', effectValue: new Decimal(3),
    scope: 'chocolatines',
  },
}
...
const milestonesBatteurPro = generateMilestones(BATTEUR_PRO, 'petrissage', 'Batteur pro', 'chocolatines', PATE_BRIOCHEE, 15)
const milestonesFondoir = generateMilestones(FONDOIR, 'garnissage', 'Fondoir', 'chocolatines', PATE_BRIOCHEE, 25)
const milestonesDoreuse = generateMilestones(DOREUSE, 'dorure', 'Doreuse', 'chocolatines', PATE_BRIOCHEE, 150)
const milestonesFourASole = generateMilestones(FOUR_A_SOLE, 'cuisson', 'Four a sole', 'chocolatines', PATE_BRIOCHEE, 300)
const milestonesPatisserie = generateMilestones(PATISSERIE, 'vente', 'Patisserie', 'chocolatines', PATE_BRIOCHEE, 600)
